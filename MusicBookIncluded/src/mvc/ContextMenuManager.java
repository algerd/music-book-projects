...
import mvc.album.loader.AlbumDialogLoader;
import mvc.artist.alert.ArtistDeleteAlert;
import mvc.artist.alert.ArtistReferenceDeleteAlert;
import mvc.artist.loader.ArtistDialogLoader;
import mvc.artist.loader.ArtistReferenceDialogLoader;
import mvc.genre.alert.GenreDeleteAlert;
import mvc.genre.loader.GenreDialogLoader;
import mvc.musician.alert.MusicianDeleteAlert;
import mvc.musician.alert.MusicianGroupDeleteDialog;
import mvc.musician.loader.MusicianDialogLoader;
import mvc.musician.loader.MusicianGroupDialogLoader;
import mvc.song.alert.SongDeleteAlert;
import mvc.song.loader.SongDialogLoader;
...
public class ContextMenuManager {     
    ...
    public ContextMenuManager() {
        menuMap.put(ItemType.ADD_ARTIST, e -> ArtistDialogLoader.show(valueMap.get(ItemType.ADD_ARTIST)));
        menuMap.put(ItemType.EDIT_ARTIST, e -> ArtistDialogLoader.show(valueMap.get(ItemType.EDIT_ARTIST)));        
        menuMap.put(ItemType.DELETE_ARTIST, e -> ArtistDeleteAlert.show((Artist) valueMap.get(ItemType.DELETE_ARTIST)));      
        
        menuMap.put(ItemType.ADD_ALBUM, e -> AlbumDialogLoader.show(valueMap.get(ItemType.ADD_ALBUM)));
        menuMap.put(ItemType.EDIT_ALBUM, e -> AlbumDialogLoader.show(valueMap.get(ItemType.EDIT_ALBUM)));
        menuMap.put(ItemType.DELETE_ALBUM, e -> AlbumDeleteAlert.show((Album) valueMap.get(ItemType.DELETE_ALBUM)));             
        
        menuMap.put(ItemType.ADD_SONG, e -> SongDialogLoader.show(valueMap.get(ItemType.ADD_SONG)));       
        menuMap.put(ItemType.EDIT_SONG, e -> SongDialogLoader.show(valueMap.get(ItemType.EDIT_SONG)));
        menuMap.put(ItemType.DELETE_SONG, e -> SongDeleteAlert.show((Song) valueMap.get(ItemType.DELETE_SONG)));       
        
        menuMap.put(ItemType.ADD_GENRE, e -> GenreDialogLoader.show(valueMap.get(ItemType.ADD_GENRE)));
        menuMap.put(ItemType.EDIT_GENRE, e -> GenreDialogLoader.show(valueMap.get(ItemType.EDIT_GENRE)));
        menuMap.put(ItemType.DELETE_GENRE, e -> GenreDeleteAlert.show((Genre) valueMap.get(ItemType.DELETE_GENRE)));     
        
        menuMap.put(ItemType.ADD_MUSICIAN, e -> MusicianDialogLoader.show(valueMap.get(ItemType.ADD_MUSICIAN)));
        menuMap.put(ItemType.EDIT_MUSICIAN, e -> MusicianDialogLoader.show(valueMap.get(ItemType.EDIT_MUSICIAN)));
        menuMap.put(ItemType.DELETE_MUSICIAN, e -> MusicianDeleteAlert.show((Musician) valueMap.get(ItemType.DELETE_MUSICIAN)));       
        
        menuMap.put(ItemType.ADD_MUSICIAN_GROUP, e -> MusicianGroupDialogLoader.show(valueMap.get(ItemType.ADD_MUSICIAN_GROUP)));
        menuMap.put(ItemType.EDIT_MUSICIAN_GROUP, e -> MusicianGroupDialogLoader.show(valueMap.get(ItemType.EDIT_MUSICIAN_GROUP)));
        menuMap.put(ItemType.DELETE_MUSICIAN_GROUP, e -> MusicianGroupDeleteDialog.show((MusicianGroup) valueMap.get(ItemType.DELETE_MUSICIAN_GROUP))); 
        
        menuMap.put(ItemType.ADD_ARTIST_REFERENCE, e -> ArtistReferenceDialogLoader.show(valueMap.get(ItemType.ADD_ARTIST_REFERENCE)));
        menuMap.put(ItemType.EDIT_ARTIST_REFERENCE, e -> ArtistReferenceDialogLoader.show(valueMap.get(ItemType.EDIT_ARTIST_REFERENCE)));
