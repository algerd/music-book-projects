 ...
 * Note these imports are different in Java 9, with com.sun.javafx.scene.control.skin being replaced by javafx.scene.control.skin. (This means they are public API as of Java 9.)
...
public class TableViewWithVisibleRowCount<T> extends TableView<T> {
    ...
    public static class TableViewSkinX<T> extends TableViewSkin<T> {
        ...
        /**
         * Calculates and returns the pref height of the for the given number of rows.
         * If flow is of type MyFlow, queries the flow directly otherwise invokes the method.
         */
