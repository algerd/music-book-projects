...
import static com.algerd.musicbookspringmaven.core.ContextMenuManager.ItemType.ADD_ARTIST;
import static com.algerd.musicbookspringmaven.core.ContextMenuManager.ItemType.DELETE_ARTIST;
import static com.algerd.musicbookspringmaven.core.ContextMenuManager.ItemType.EDIT_ARTIST;

public class ArtistGenreTableController extends BaseController implements Initializable {
